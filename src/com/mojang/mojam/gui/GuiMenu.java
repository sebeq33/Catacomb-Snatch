...
public abstract class GuiMenu extends GuiComponent implements ButtonListener, KeyListener {
	...
	public void keyPressed(KeyEvent e) {
		if (e.getKeyCode() == KeyEvent.VK_UP || e.getKeyCode() == Options.getAsInteger("key_up")) {
			selectedItem--;
			if (selectedItem < 0) {
		...
		} else if (e.getKeyCode() == KeyEvent.VK_LEFT || e.getKeyCode() == Options.getAsInteger("key_left")) {
