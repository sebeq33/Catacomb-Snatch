...
public class TitleMenu extends GuiMenu {
	...
	public static final int SELECT_LEVEL_EDITOR = 1023;
	...
	public static final int RETURN_TO_EDITOR = 1024;
	...
	public static GameMode currentGameMode = new GameModeVanilla();
	...
	private final Bitmap titleScreen = TurnSynchronizer.synchedRandom.nextInt(2) == 0 ? Art.titleScreen : Art.downloadScreen;
