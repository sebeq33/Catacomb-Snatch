...
public class LevelInformation {
	...
	/*public int[] spawnPoints = new int[2];
	public boolean playerSpawnCenterX = true;*/
...
//	}
	...
	/*public LevelInformation(String levelName, String levelFile, boolean vanilla, int x, int y) {
		this.levelName = levelName;
		this.levelFile = sanitizePath(levelFile);
		this.vanilla = vanilla;
		playerSpawnCenterX = false;
		spawnPoints[0] = x;
		spawnPoints[1] = y;
