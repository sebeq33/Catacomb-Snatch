...
public class HoleTile extends Tile {
	...
	public void init(Level level, int x, int y) {
		...
		else if ((level.getTile(x, y - 1) instanceof WaterTile)) {
			WaterTile water = (WaterTile) level.getTile(x, y - 1);
			if (water.isDeep()) img = 19;
			else img = 17;
		}
	}
	...
	public boolean canPass(Entity e) {
		return ((e instanceof Bullet) || (e instanceof Mob && ((Mob) e).flying) || (e instanceof Player) || (e instanceof Loot));
	}
