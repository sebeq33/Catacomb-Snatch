...
public enum DifficultyInformation {
	EASY(MojamComponent.texts.getStatic("diffselect.easy"), .5f, .5f, 1.5f, .5f, false, 20, 3),
	NORMAL(MojamComponent.texts.getStatic("diffselect.normal"), 1, 1, 1, 1, false, 25, 7),
	HARD(MojamComponent.texts.getStatic("diffselect.hard"), 3, 2, .5f, 1.5f, true, 35, 12),
	NIGHTMARE(MojamComponent.texts.getStatic("diffselect.nightmare"), 6, 4, .25f, 2.5f, true, 45, 100000);
