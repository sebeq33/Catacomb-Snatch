...
public class Art {
    ...
    public static Bitmap[][] pharaohSpawner = cut("/art/map/pharaohSpawner.png", 32, 40);
    ...
    public static Bitmap[][] lockedDoor = cut("/art/map/lockeddoor.png", 32, 56);
    ...
    public static Bitmap emptyBackgroundWindow = load("/art/screen/empty_background_window2.png");
    public static Bitmap trashIcon = load("/art/screen/icon_trash_16.png");
    ...
    public static Bitmap[][] pharaoh = cut("/art/mob/enemy_pharaoh_anim_48.png", 48, 48);
    ...
    // pickups
    public static Bitmap[][] pickupKey = cut("/art/pickup/pickup_key_16.png", 16, 16);
    public static Bitmap[][] pickupHeart = cut("/art/pickup/pickup_heart_16.png", 16, 16);
    public static Bitmap[][] pickupMap = cut("/art/pickup/pickup_map_16.png", 16, 16);
    ...
    public static Bitmap[][] shineSmall = cut("/art/effects/effect_shine_small_13.png", 13, 13);
    public static Bitmap[][] shineBig = cut("/art/effects/effect_shine_big_13.png", 13, 13);
